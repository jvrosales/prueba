...
@Stateless
public class GoalsCatalogDao extends AbstractFacade<GoalsCatalog, Integer> implements Serializable{	

	/**
	 * 
	 */
	private static final long serialVersionUID = 8355541018588528388L;

	public GoalsCatalogDao() {
