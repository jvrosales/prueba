 ...
 */
@Entity
@Table(name="suia_iv_seguimiento_documento", schema = "suia_iv")
@NamedQuery(name="SuiaIvSeguimientoDocumento.findAll", query="SELECT s FROM SuiaIvSeguimientoDocumento s")
public class SuiaIvSeguimientoDocumento implements Serializable {
	private static final long serialVersionUID = 1L;

	@Getter
	@Setter
	@Id
	@SequenceGenerator(name="seq_suia_iv_seg_documento" ,initialValue = 1, sequenceName = "seq_suia_iv_seg_documento", schema = "suia_iv", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="seq_suia_iv_seg_documento")
	@Column(name="codigo_seguimiento_documento")
	private Long codigo;
	...
	public SuiaIvSeguimientoDocumento() {
	}
